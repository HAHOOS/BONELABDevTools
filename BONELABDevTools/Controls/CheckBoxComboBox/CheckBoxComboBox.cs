...
namespace PresentationControls
{
    ...
    public class CheckBoxComboBoxListControl : ScrollableControl
    {
        ...
        public void SynchroniseControlsWithComboBoxItems()
        {
            ...
            if (this.InvokeRequired) this.Invoke(Controls.Clear);
            else Controls.Clear();
            ...
            if (NewList.Count > 0)
            {
                ...
                if (this.InvokeRequired) this.Invoke(Controls.AddRange, NewList.ToArray());
                else Controls.AddRange(NewList.ToArray());
            }
